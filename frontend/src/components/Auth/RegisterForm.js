...
const RegisterForm = () => {
  ...
  return (
    ...
    >
      ...
      <Form.Field>
        <Form.Input icon='group' iconPosition='left' placeholder="Group (user/root/company/foodStaff/seminarStaff/poster/clerk)" type="text" required={true} id="userGroup" onChange={e => { setGroup(e.target.value); }} />
      </Form.Field>
      <Form.Field>
